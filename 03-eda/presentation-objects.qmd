...
orientation_fan_anim <- animate(orientation_fan, width = 800, height = 600, nframes = 100)

anim_save("05-presentation-files/orientation_fan.gif", animation = orientation_fan_anim)
```
