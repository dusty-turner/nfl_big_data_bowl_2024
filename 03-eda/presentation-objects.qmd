...
week_1 |> filter(is.na(pass_result)) |> filter(possession_team == "TB", defensive_team == "DAL") |> count(game_idplay_id)
...
week_1 %>% filter(game_idplay_id == "20220911131038") |> filter(tackle == 1) |> select(display_name, jersey_number)

# Assuming week_1 is your data frame
animated_plot <-
  week_1 %>% filter(game_idplay_id == "20220911131038") |> 
