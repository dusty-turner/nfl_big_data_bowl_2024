...
run_nn <- function(units_param = 50, rate_param = .5, l2_value_param = .01, epochs_param = 10, 
  ...
  print(units_param)
  print(rate_param)
  print(l2_value_param)
  print(positive_weight_param)
  print(epochs_param)
...
tibble(
  ...
  optimizer = optimizer_param, rate = rate_param, time = now(), user = Sys.info()["user"], 
  positive_weight = positive_weight_param,model_execution_time = model_execution_time, notes = notes_param
) |> 
...
out <- run_nn(
  ...
  notes_param = "trying to zero in a best model",
  positive_weight_param = 9,
  optimizer_param = "adam"
  # activation_param = "relu"
)

epoch_values <- c(4)
rate_values <- c(.05,1,1.5)
l2_values <- c(.001)
positive_weight_value <- c(9,11,13)
units_value <- c(75)

map2(.x = c(9,11), .y = c(3,4), .f = ~run_nn(positive_weight_param = .x, epochs_param = .y))
...
param_grid <- expand.grid(epochs_param = epoch_values,
  ...
  # sample_n(35)
pmap(param_grid, run_nn)



pmap_dfr(param_grid, ~run_nn(
  epochs_param = ..1,
  units_param = ..4,  # Assuming a fixed value
  rate_param = ..2,
  l2_value_param = ..3,
  layers_param = 6,  # Assuming a fixed value
  batch_size_param = 441,  # Assuming a fixed value
  notes_param = "Hyperparameter tuning",
  positive_weight_param = ..5,
