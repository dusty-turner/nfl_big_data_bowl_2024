...
out <- run_nn(
  ...
  # positive_weight_param = ratio,
  notes_param = "after center and scaling no more regularization",
...
```{r}
write_rds(list(test_joined_with_preds = test_joined_with_preds, week_1 = week_1),"04-models/model_results.rds")
write_rds(list(test_joined_with_preds = test_joined_with_preds, week_1 = week_1),"../../Desktop/nfl_big_data_bowl_2024/04-models/model_results.rds")
file.copy(from = "04-models/model_results.rds", to = "../../Desktop/nfl_big_data_bowl_2024/04-models/model_results.rds", overwrite = TRUE)
list.files("../../Desktop/nfl_big_data_bowl_2024/04-models/model_results.rds")
```
