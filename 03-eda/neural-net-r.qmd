...
continuous_factors <- c("x", "y", "x_ball", "y_ball", "s", "a", "o", "distance_to_ball", "x_going", "y_going", "dir", "x_ball_next", "y_ball_next", "s_ball", "o_ball", "dir_ball", "angle_to_ball", "pass_probability")

        
# [19] "position"              "offense_formation"     "quarter"               "down"                  "rank"                  "defenders_in_the_box" 
# [25] "ball_in_fan3"          "ball_in_fan2"          "ball_in_fan1"          ""      "yards_to_go"           "x_from_los"           
# [31] "height"                "weight"                
...
newdata <-
  ...
  select(game_id,play_id, display_name, frame_id, all_of(continuous_factors), tackle) |> 
...
get_play_data <- function(game_id_arg = newdata$game_id[[1]], play_id_arg = newdata$play_id[[1]], df, num_features_per_player_arg) {
    ...
    for (i in seq_len(num_frames)) {
        frame_data <- play_data %>%
            ...
            select(all_of(continuous_factors))
